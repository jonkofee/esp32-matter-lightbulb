...
static esp_err_t app_driver_light1_set_power(led_driver_handle_t handle, esp_matter_attr_val_t *val)
{
    return gpio_set_level(GPIO_NUM_25, val->val.u32);
}
static esp_err_t app_driver_light2_set_power(led_driver_handle_t handle, esp_matter_attr_val_t *val)
{
    return gpio_set_level(GPIO_NUM_33, val->val.u32);
}
    ...
    if (endpoint_id == light1_endpoint_id) {
        ...
        if (cluster_id == OnOff::Id) {
            if (attribute_id == OnOff::Attributes::OnOff::Id) {
                err = app_driver_light1_set_power(handle, val);
            }
        ...
        if (cluster_id == OnOff::Id) {
            if (attribute_id == OnOff::Attributes::OnOff::Id) {
                err = app_driver_light2_set_power(handle, val);
            }
        } else if (cluster_id == LevelControl::Id) {
            if (attribute_id == LevelControl::Attributes::CurrentLevel::Id) {
                err = app_driver_light_set_brightness(handle, val);
